...
[Earlier attempts](https://medium.com/@analyticalgaming/isageoverrated-fc2b58059a17) to analyze age effects in CS:GO have examined bivariate correlations between a player's age and their overall HLTV Rating 2.0. I have c. This way we can examine the *trajectory* of players over time as well as evaluate the potential for age effects to differ over time (due to, for example, changes in the ). 
